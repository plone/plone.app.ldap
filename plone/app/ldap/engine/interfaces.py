...
class ILDAPBinding(Interface):
    ...
    rdn_attribute = Choice(
        title=_(
            u'label_ldap_dn_attribute',
            default=u'rDN attribute'),
        description=_(
            u'help_ldap_dn_attribute',
    ...
    user_object_classes = ASCIILine(
        title=_(
            u'label_ldap_user_object_classes',
    ...
    password_encryption = Choice(
        title=_(
            u'label_ldap_user_password_encryption',
    ...
    default_user_roles = ASCIILine(
        title=_(
            u'label_ldap_default_user_roles',
            default=u'Default user roles'),
        description=_(
            u'help_ldap_default_user_roles',
...
class ILDAPConfiguration(ILDAPBinding):
    ...
    activated_plugins = List(
        title=_(u'Activated plugins'),
        value_type=ASCIILine(title=u'interface',))
...
class ILDAPServerConfiguration(Interface):
    ...
    connection_type = Choice(
        title=_(
            u'label_ldap_connection_type',
            default=u'Connection type'),
        description=_(
            u'help_ldap_connection_type',
            default=u''),
    ...
    operation_timeout = Int(
        title=_(
            u'label_operation_timeout',
            default=u'Operation timeout'),
        description=_(
            u'help_operation_timeout',
            default=u'The timeout in seconds to wait for an operation such '
                    u'as a search or update to complete. If no timeout '
                    u'should be used use -1 as value.'),
        default=-1,
        min=-1,
        max=300,
        required=True)
...
class ILDAPPropertyConfiguration(Interface):
    description = TextLine(
        title=_(
            u'label_property_description',
            default=u'Property description'),
        required=False)

    ldap_name = ASCIILine(
        title=_(
            u'label_ldap_property',
            default=u'LDAP property name'),
        description=_(
            u'help_ldap_property',
