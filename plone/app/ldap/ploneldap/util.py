...
def createLDAPPlugin():
    ...
    genericPluginCreation(pas, klass, 
            ...
            login_attr=config.schema[config.login_attribute].ldap_name,
            uid_attr=config.schema[config.userid_attribute].ldap_name,
            rdn_attr=config.schema[config.rdn_attribute].ldap_name,
